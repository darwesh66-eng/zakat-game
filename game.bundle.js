...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:vi,depthTest:!1,depthWrite:!1})}function Jd(){return new Nn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:lh(),fragmentShader:`
		...
		`,blending:vi,depthTest:!1,depthWrite:!1})}function jd(){return new Nn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:lh(),fragmentShader:`
...
`].filter(wo).join(`
`)),o=sh(o),o=hf(o,t),o=uf(o,t),a=sh(a),a=hf(a,t),a=uf(a,t),o=df(o),a=df(a),t.isRawShaderMaterial!==!0&&(b=`#version 300 es
